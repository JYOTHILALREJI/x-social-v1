...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black p-4 selection:bg-purple-500/30">
        ...
        <AnimatePresence mode="wait">
          {ageError ? (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-6"><div className="h-[1px] flex-1 bg-zinc-800" /><span className="text-[10px] uppercase text-zinc-600 font-black">OR</span><div className="h-[1px] flex-1 bg-zinc-800" /></div>
